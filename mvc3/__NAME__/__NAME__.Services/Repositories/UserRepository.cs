...
namespace __NAME__.Services.Repositories
{
    ...
    public class UserRepository : BaseRepository<User>, IUserRepository
    {
        ...
        {           
            ...
            var query = from a in this.Context.Users where a.Email == email && a.PasswordHash == hash select a;
        ...
        {
            var query = from a in this.Context.Users where a.Email == email select a;
            return query.SingleOrDefault();
        }
    }
}
