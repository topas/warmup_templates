...
namespace __NAME__.Services.Repositories
{
        ...
        where TModel : class
    {
        ...
        {
            this.Context.GetCollection<TModel>().Delete(obj);
        }

        /// <summary>
        /// Saves this instance.
        /// </summary>
        /// <param name="obj">The object for save.</param>
        public void Save(TModel obj)
        {
            this.Context.GetCollection<TModel>().Save(obj);
        }
        ...
        {
            var query = from a in this.Context.GetCollection<TModel>().AsQueryable() select a;
            return query; 
        }
